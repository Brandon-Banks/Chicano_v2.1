...
ds_map_add(textMap,"","Granger.");
ds_map_add(textOptions,"","You have another day off which is nice!\n\nPress Enter");
...
ds_map_add(textOptions,"E3EE","Maria, the manager, asks you if\nyou could help out with the daycare.\n\nPress Enter");
...
ds_map_add(textOptions,"E3EEE1","Maria thanks you!\n\nPress Enter");
...
ds_map_add(textOptions,"E3EEE2","Maria says, 'Alright...'\n\nPress Enter");
